...
df_pixelAvgValues_left=pd.read_csv('Pixel_Arr_leftCheek (12).csv',";")
df_pixelAvgValues_right=pd.read_csv('Pixel_Arr_rightCheek (13).csv',";")
df_pixelAvgValues_forehead=pd.read_csv('Pixel_Arr_forehead (10).csv',";")
...
```python
#right cheek was darker in the recording
```
